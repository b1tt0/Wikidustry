module.exports.run = async (bot, msg, args, embed, util) => {
  ...
  if (block === "all") {
    embed.setTitle(util.text.distr.all)
      .setDescription(`\u200b`);
    
    util.blocks.forEach(curr => {
      if (curr.category !== "Distribution") return;
...
${util.text.block.speed} **${curr.speed} items/second**
${util.text.block.itemsCapacity} **${curr.capacity} items**
`, true)
    ...
    curr.cost.forEach(req => {
      ...
      switch(req[0]) {
        ...
        case "Lead": reqq = "<:lead:683609419094818842>"; break
        case "Titanium": reqq = "<:titanium:683619185125097526>"; break
        case "Graphite": reqq = "<:graphite:683648622792802370>"; break
        ...
        case "Silicon": reqq = "<:silicon:683645184851836978>"; break
        default: reqq = req[0]
      }
...
module.exports.help = {
  name: "Distribution",
  description: "Show distribution block info",
  usage: "distribution [name]",
